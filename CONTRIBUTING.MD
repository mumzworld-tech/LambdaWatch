# Contributing to mumzworld-tech/LambdaWatch

We welcome contributions to the `mumzworld-tech/LambdaWatch` package! Before you start, please take a moment to read this guide.
...
2.  **Scope:** Ensure the suggestion relates directly to AWS Lambda and Grafana Loki.

## 💻 Development Workflow

To contribute code, please follow these steps:

1.  **Fork:** Fork the `mumzworld-tech/LambdaWatch` repository.
...
4.  **Branch:** Create a new branch for your feature or fix (e.g., `feature/adding-new-feature` or `fix/error-reporting`).
5.  **Code:** Write your code, ensuring it adheres to standard Go coding practices.
